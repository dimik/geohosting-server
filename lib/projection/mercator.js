...
module.exports = function (options) {
  ...
  this.xToLongitude = function (x) {
    return utils.math.cycleRestrict(x * subradius, -Math.PI, Math.PI) * c_180pi;
  };
  ...
  this.longitudeToX = function (lng) {
    var longitude = utils.math.cycleRestrict(lng * c_pi180, -Math.PI, Math.PI);
  ...
  this.latitudeToY = function (lat) {
    ...
    var latitude = utils.math.restrict(lat, -90 + epsilon, 90 - epsilon) * c_pi180;
